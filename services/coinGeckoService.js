...
// Refactor of Repetitive API Calls with Helper Functions

const fetchFromCoinGecko = async (url, params) => {
...
export const fetchMarketData = async () => fetchFromCoinGecko(coinsMarketsUrl, 
    {
        vs_currency: 'usd',          
...
export const fetchPriceData = async (ids) => fetchFromCoinGecko(simplePriceUrl, {
    ids,
    vs_currencies: 'usd',
...
export const fetchCoinDetails = async (id) => fetchFromCoinGecko(coinDetailsUrl(id));
